...
namespace rambler { namespace memory {
	...
	class MemoryManager_generic : public MemoryManager {
	public:

		~MemoryManager_generic() = default;
		...
		* @see    share_memory
		*/
		virtual void * reserve_memory(size_t n, size_t size) override;
		...
		* @see    share_memory
		*/
		virtual void * reserve_memory(size_t amount) override;
		...
		*/
		virtual void release_memory(void * ptr) override;
		...
		*/
		virtual void share_memory(void * ptr) override;
	private:
